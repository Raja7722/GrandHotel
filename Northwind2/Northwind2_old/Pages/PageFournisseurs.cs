...
namespace Northwind2.Pages
{
	public class PageFournisseurs : MenuPage
	{
		...
		{
			_pays = Northwind2App.DataContext.GetPaysFournisseurs();
		...
		private void AfficherFournisseursPays()
		{
			...
			_fournisseurs = Northwind2App.DataContext.GetFournisseurs(pays);
		...
		private void AfficherNbProduitsPays()
		{
			...
			int nb = Northwind2App.DataContext.GetNbProduits(pays);
